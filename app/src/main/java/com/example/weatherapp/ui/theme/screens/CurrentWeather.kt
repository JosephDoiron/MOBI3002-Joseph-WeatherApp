...
fun CurrentWeatherScreen(mainViewModel: MainViewModel) {
    ...
    weather?.let { currentWeather ->
        ...
        Column(
            ...
            Card(
                modifier = Modifier
                    .wrapContentWidth()   // width adjusts to content
                    .wrapContentHeight()
                    .padding(16.dp),
                shape = MaterialTheme.shapes.extraSmall,  // 👈 uses your theme’s medium round
                colors = CardDefaults.cardColors(containerColor = Color.Black.copy(alpha = 0.5f)),
//                elevation = CardDefaults.cardElevation(defaultElevation = 8.dp)
//                contentAlignment = Alignment.Center
            ) {
                Column(
                    modifier = Modifier.padding(24.dp),  // inner padding so text isn’t cramped,
                    horizontalAlignment = Alignment.CenterHorizontally) {
                    Text(
